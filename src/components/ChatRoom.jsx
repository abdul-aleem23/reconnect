...
const ChatRoom = ({ onRoomChange }) => {
  ...
  return (
    <div className="w-full h-screen flex flex-col md:flex-row lg:flex-row justify-center items-center bg-sky-100">
      ...
      <div className="w-2/5 flex flex-col md:h-full lg:h-full justify-start items-center md:bg-white lg:bg-white sm:bg-sky-100">
        <div className="mt-4">
        <Player autoplay loop src={famPhoto}></Player>
        </div>
        <div className="flex flex-col">
          <div className="flex flex-row my-2">
            <p className="text-slate-900 mr-2">Join your room</p>
